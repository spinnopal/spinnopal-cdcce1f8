...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "The Luck Spin" },
      { title: "The Luck Spin" },
      { name: "description", content: "The Luck Spin — premium prize campaigns for retail shops. Spin · Win · Enjoy." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "The Luck Spin" },
      { property: "og:description", content: "The Luck Spin — premium prize campaigns for retail shops. Spin · Win · Enjoy." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "The Luck Spin" },
      { name: "twitter:description", content: "The Luck Spin — premium prize campaigns for retail shops. Spin · Win · Enjoy." },
