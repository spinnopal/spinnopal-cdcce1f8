...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "spin the luck" },
      { name: "description", content: "Spin the luck is a premium Android app for retail campaigns." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "spin the luck" },
      { property: "og:description", content: "Spin the luck is a premium Android app for retail campaigns." },
